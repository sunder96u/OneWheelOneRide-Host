...
export default function newProductReviewModal ({open, onClose, reviews, product}) {
        ...
        <div onClick={onClose}>
            <Modal show={open} onClick={(e) => {e.stopPropagation()}}>
                <Modal.Header closeButton onClick={onClose}>
                    <Modal.Title className="black">Edit Review</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="rating" className="form-label black">Rating:</label>
                                <div className="form-check form-check-inline">
                                    <input className="for-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" onClick={() => setRating(1)} ></input>
                                ...
                                <div className="form-check form-check-inline">
                                    <input className="for-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" onClick={() => setRating(4)} value="4" defaultChecked></input>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" id="comment" onChange={(e) => setReview(e.target.value)}>{reviews.review}</textarea>
                        </div>
                    </form>
                </Modal.Body>
                <Modal.Footer>
